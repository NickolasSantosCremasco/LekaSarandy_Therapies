...
<body>
    ...
    <section class="container py-5 mt-5">
        ...
        <div id="introScream" class="text-center">
            <h1 class="display-4">Descubra seu Perfil</h1>
            <p class="lead mb-4">Responda honestamente para descobrir quais padrões emocionais mais influenciam sua vida
            </p>
        ...
        <div id="quizContainer" class="d-none">
            ...
            <div class="progress mb-4" style="height: 10px;">
                <div id="quizProgress" class="progress-bar bg-warning" role="progressbar" style="width: 0%;"></div>
            </div>
            ...
            <div class="d-flex justify-content-between">
                <button id="prevBtn" class="btn btn-warning">Anterior</button>
        ...
        <div id="resultContainer" class="d-none text-center">
            <div class="card border-0 bg-light">
                <div class="card-body p-5">
                    <h2 id="resultImage" class="mb-4"></h2>
                </div>
            </div>
        </div>
